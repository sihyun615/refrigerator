...
| <small>• 프로젝트 전체 관리<br>• 팀원 서포트<br>• 댓글 구현<br>• 프론트엔드 연결</small> | <small>• 카드 CRUD<br>• 프론트엔드 연결</small> | <small>• 보드 CRUD<br>• 프론트엔드 구현<br>• 프론트엔드 연결</small> | <small>• 컬럼 CRUD<br>• 프론트엔드 연결</small> | <small>• 회원가입<br>• 로그인<br>• 프론트엔드 연결</small> |
